      ...
      <Card>
        ...
        <Card.Body>
          <Card.Text>
            ...
            programming languages so I can build projects on my own time. In
            fact, one of my biggest goals as a developer is to create my own
            video game! <br /> <br /> Some of the things I do in my spare time
            is reading, gaming, playing music, cooking, and hanging out with
            friends and family!
          </Card.Text>
        </Card.Body>
      </Card>
